...
class StdAttendance(models.Model):
    ...
    student_id = fields.Many2one('res.partner', string='Student', required=True, 
                                 help='The student for whom the attendance is recorded')
    ...
    studied_hours = fields.Float(string='Studied Hours', compute='_compute_studied_hours', store=True, 
                                 help='Total hours studied by the student during the attendance period')